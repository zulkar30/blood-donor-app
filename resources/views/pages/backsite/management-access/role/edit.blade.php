                                        ...
                                        <form class="form form-horizontal" action="{{ route("backsite.role.update", [$role->id]) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="name">Role <code style="color:red;">required</code></label>
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="name" name="name" class="form-control" placeholder="example admin or users" value="{{ old('name', isset($role) ? $role->name : '') }}" autocomplete="off" required>
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            ...
                                                            <select name="permission[]"
                                                                ...
                                                                @foreach($permission as $id => $permission_item)
                                                                    <option value="{{ $permission_item->id }}" {{ (in_array($permission_item->id, old('permission', [])) || isset($role) && $role->permission->contains($permission_item->id)) ? 'selected' : '' }}>{{ $permission_item->name }}</option>
                                                                @endforeach
                                                            </select>
